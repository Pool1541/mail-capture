...
const VISIBILITY_TIMEOUT = 180; // 3 minutos para scraping con Playwright

if (!QUEUE_URL) {
  throw new Error("SQS_SCRAPER_QUEUE_URL environment variable is required");
}

export class ScraperQueueService implements QueueService {
