...
const VISIBILITY_TIMEOUT = 60; // 60 segundos para validación

if (!QUEUE_URL) {
  throw new Error("SQS_VALIDATION_QUEUE_URL or SQS_QUEUE_URL environment variable is required");
}

export class ValidationQueueService implements QueueService {
